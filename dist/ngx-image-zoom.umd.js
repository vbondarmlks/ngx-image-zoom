(function(global, factory) {
    ...
    var NgxImageZoomComponent = (function() {
        ...
        Object.defineProperty(
            NgxImageZoomComponent.prototype,
            "setThumbImage",
            {
                /**
                 * @param {?} thumbImage
        ...
        Object.defineProperty(NgxImageZoomComponent.prototype, "setZoomMode", {
            ...
            set: function(zoomMode) {
                if (
                    NgxImageZoomComponent.validZoomModes.some(function(m) {
                        return m === zoomMode;
                    })
                ) {
        ...
        Object.defineProperty(
            ...
            "setMagnification",
            {
                ...
                set: function(magnification) {
                    this.magnification =
                        Number(magnification) || this.magnification;
        ...
        Object.defineProperty(
            ...
            "setMaxZoomRatio",
            {
                ...
                set: function(maxZoomRatio) {
                    this.maxZoomRatio =
                        Number(maxZoomRatio) || this.maxZoomRatio;
                },
                enumerable: true,
                configurable: true
            }
        ...
        Object.defineProperty(
            ...
            "setScrollStepSize",
            {
                ...
                set: function(stepSize) {
                    this.scrollStepSize =
                        Number(stepSize) || this.scrollStepSize;
                },
                enumerable: true,
                configurable: true
            }
         ...
         */ = function(event) {
            ...
            var /** @type {?} */ left =
                    event.pageX - this.offsetLeft + scrollLeftOffset;
            var /** @type {?} */ top =
                    event.pageY - this.offsetTop + scrollTopOffset;
            var /** @type {?} */ newLeft = Math.max(
                    Math.min(left, this.thumbWidth),
                    0
                );
            var /** @type {?} */ newTop = Math.max(
                    Math.min(top, this.thumbHeight),
                    0
                );
         ...
         */ = function() {
            ...
            this.fullImageLeft =
                this.latestMouseLeft * -this.xRatio - lensLeftMod;
         ...
         */ = function() {
            ...
            this.xRatio =
                (this.magnifiedWidth - this.thumbWidth) / this.thumbWidth;
            this.yRatio =
                ...
                args: [
                    {
                        ...
                        styles: [
                            ".ngxImageZoomContainer { position: relative; margin: auto; overflow: hidden; } .ngxImageZoomFull { position: absolute; max-width: none; max-height: none; display: none; } .ngxImageZoomFullContainer { position: absolute; overflow: hidden; } .ngxImageZoomFullContainer.ngxImageZoomLensEnabled { border: 2px solid red; cursor: crosshair; } "
                        ]
                    }
                ]
            }
        ...
        NgxImageZoomComponent.propDecorators = {
            ...
            imageThumbnail: [
                { type: core.ViewChild, args: ["imageThumbnail"] }
            ],
            ...
            setEnableScrollZoom: [
                { type: core.Input, args: ["enableScrollZoom"] }
            ],
            setScrollParentSelector: [
                { type: core.Input, args: ["scrollParentSelector"] }
            ]
        };
